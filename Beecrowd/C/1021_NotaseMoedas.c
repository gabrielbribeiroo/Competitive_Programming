...
void QuantidadeNotas(double *num, int *c100, int *c50, int *c20, int *c10,
                     int *c5, int *c2) {
  double x = *num;
...
void QuantidadeMoedas(double *num, int *m1, int *m050, int *m025, int *m010,
                      int *m005, int *m001) {
  double x = *num;
...
void MostraNotas(double *num, int *c100, int *c50, int *c20, int *c10, int *c5,
                 int *c2) {
  printf("NOTAS:\n");
...
void MostraMoedas(double *num, int *m1, int *m050, int *m025, int *m010,
                  int *m005, int *m001) {
  printf("MOEDAS:\n");
