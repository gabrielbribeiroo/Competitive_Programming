...
saida, tempo, fuso = map(int, input().split()) # Leitura da hora da saída, do tempo de viagem e do fuso horário do destino com relação à origem
chegada = (saida+tempo+fuso) % 24 # Calcula a hora de chegada

if (chegada < 0):
    chegada += 24 # Ajusta o valor, caso seja negativo

print(chegada) # Imprime a hora loval prevista no destino
