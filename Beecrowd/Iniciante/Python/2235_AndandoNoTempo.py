...
a, b, c = map(int, input().split()) # Leitura dos valores dos 3 créditos

# Verifica se é possível voltar ao presente com combinações dos créditos
if a == b + c or b == a + c or c == a + b or \
   a == b or a == c or b == c or \
   a + b + c == 0:
    print("S")
else:
    print("N")