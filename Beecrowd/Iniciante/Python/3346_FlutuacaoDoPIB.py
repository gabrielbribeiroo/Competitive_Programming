...
f1, f2 = map(float, input().split()) # Leitura dos valores de entrada

# Cálculo do fator de crescimento para cada ano
fator_ano1 = 1 + f1 / 100
fator_ano2 = 1 + f2 / 100

fator_total = fator_ano1 * fator_ano2 # Cálculo do fator de crescimento total ao longo dos dois anos
flutuacao_total = (fator_total - 1) * 100 # Cálculo da flutuação total em porcentagem
